...
"$BUN" install
echo "=== node_modules/.bun entries matching platform-bun ==="
find node_modules/.bun -maxdepth 1 -iname '*platform-bun*'
echo "=== recursive listing of the platform-bun store entry's dist/ ==="
find node_modules/.bun -maxdepth 1 -iname '*platform-bun*' -exec find {} -maxdepth 4 \;
